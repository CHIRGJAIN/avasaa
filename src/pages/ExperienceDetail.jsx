...
function ExperienceDetail() {
  ...
  if (!experience) {
    return (
      <div className="bg-[#FAF8F5] min-h-screen flex flex-col items-center justify-center pt-24 px-6 space-y-6">
        <h2 className="font-serif text-2xl text-primary font-bold">Experience Not Found</h2>
        <p className="font-sans text-sm text-gray-500">The experience details you are looking for do not exist.</p>
        <Link to="/experiences" className="bg-primary text-white px-8 py-3 rounded-full font-sans text-xs font-bold uppercase tracking-widest shadow-md hover:bg-[#3e5349]">
          Back to Experiences
        </Link>
      </div>
    );
