  ...
  return (
    <div>
      ...
      <header className="relative w-full h-[65vh] md:h-[75vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center justify-center text-center animate-bounce opacity-70 w-max">
          <span className="font-sans text-[10px] font-semibold uppercase tracking-widest text-white mb-2 text-center block w-full">Explore Stays</span>
      ...
      <section className="bg-surface-container-low rounded-[40px] px-6 py-24 max-w-7xl mx-auto mb-12">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 text-left">
            ...
            <div className="p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/40 shadow-sm hover:shadow-md transition-shadow">
              <img src={chefIllustration} alt="Organic Dining" className="h-16 w-auto mb-4 object-contain mix-blend-multiply" />
              <h4 className="font-serif text-lg text-primary mb-2">Organic Dining</h4>
              <p className="font-sans text-sm text-on-surface-variant font-light leading-relaxed">
