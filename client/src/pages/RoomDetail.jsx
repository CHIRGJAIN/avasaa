...
function RoomDetail() {
  ...
  const roomContent = {
    ...
    'cedar-suite': {
      ...
      aboutLong: "Tattva invites you to experience the mountains at their own pace. Step onto your private balcony to watch the clouds drift through the valley, spend your afternoons lost in a good book, and let the silence become part of your stay. It's a room made for rest, reflection, and reconnecting with nature.",
      highlights: [
        { icon: 'balcony', text: 'Private Balcony' },
        { icon: 'wifi', text: 'Wifi' },
        { icon: 'pets', text: 'Pet Friendly' },
    ...
    'oak-studio': {
      ...
      aboutLong: 'Simple, warm, and inviting, Samsara is the perfect place to unwind after a day in the mountains. Whether you are enjoying a quiet moment on the shared balcony or settling into your room with a warm cup of coffee, comfort comes naturally here.The reading nook is stocked with curated mountain literature, and the studio porch opens directly onto the garden — a living canvas that changes with the seasons from spring blossoms to winter snow.',
      highlights: [
        { icon: 'balcony', text: 'Private Balcony' },
        { icon: 'wifi', text: 'Wifi' },
        { icon: 'pets', text: 'Pet Friendly' },
    ...
    'private-rooms': {
      ...
      aboutLong: "Designed for solo travellers, backpackers, and groups looking to experience the mountains together. Lokah is more than a place to sleep. It's where conversations begin over morning coffee, friendships are formed after a day of exploring, and stories are exchanged beneath star-filled skies. Comfortable, welcoming, and full of character, it brings people together in the best way.",
      highlights: [
        { icon: 'balcony', text: 'Shared Balcony' },
        { icon: 'bed', text: 'Individual Bed with Reading Light' },
        { icon: 'power', text: 'Personal Charging Point' },
        { icon: 'lock', text: 'Lockers' },
        { icon: 'wifi', text: 'Wi-Fi' },
      ],
      included: [
        { title: 'Accommodation', desc: 'Single bed space in a cozy shared dormitory cabin' },
        { title: 'Locker', desc: 'Secure storage locker for your backpack and personal items' },
        { title: 'Charging Point', desc: 'Individual electrical socket and reading light at your bed' },
        { title: 'Washroom Access', desc: 'Access to attached washroom with running hot water' },
        { title: 'Common Lounge', desc: 'Access to sharing balconies and fire pits with other guests' },
      ],
      excluded: [
        { title: 'Meals', desc: 'All meals (available at the café on a la carte basis)' },
        { title: 'Transport', desc: 'Airport or railway station pickup and drop' },
        { title: 'Toiletries', desc: 'Soap, shampoo and towels (can be requested/purchased)' },
      ],
      faqs: [
        { q: 'How many beds are in the dormitory?', a: 'Lokah Dormitory has 6 single beds. Each bed has its own privacy curtain, reading light, and power outlet.' },
        { q: 'Is there secure storage?', a: 'Yes, secure lockers are provided. Please bring your own lock or purchase one from our reception.' },
        { q: 'Are sheets and blankets provided?', a: 'Yes, fresh blankets, clean sheets, and a pillow are provided on arrival.' },
      ],
      thingsToPack: [
        { icon: 'checkroom', text: 'Warm Layers' },
        { icon: 'flashlight_on', text: 'Flashlight' },
        { icon: 'lock', text: 'Padlock' },
        { icon: 'badge', text: 'ID Proof' },
      ],
    },
  };
  ...
  const content = roomContent[room.id] || roomContent['pine-chalet'];
  const roomImages = room.images || [room.image] || content.galleryImages;
      ...
      <div className="pt-0 pb-4 px-0 bg-white">
        <div className="w-full">
          ...
          <div className="relative rounded-b-[32px] md:rounded-b-[48px] rounded-t-none overflow-hidden h-[55vh] md:h-[80vh] shadow-sm bg-stone-100 group">
            ...
            <button
              onClick={() => setActiveSlide((prev) => (prev === 0 ? roomImages.length - 1 : prev - 1))}
            ...
            <button
              onClick={() => setActiveSlide((prev) => (prev + 1) % roomImages.length)}
