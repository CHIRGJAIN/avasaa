...
export const roomsData = [
  ...
  },
  {
    ...
    description: "Perfect for the solo explorer or a couple seeking intimacy, Samsara is a masterclass in functional minimalism. Its compact layout maximizes light and views, providing a serene base for your mountain adventures.",
    amenities: [
      "Reading Nook",
      "Natural Light",
      "Queen Size Bed",
